...
export type AyPaymentsTenantRegisterPayload =
  | AyPaymentsTenantRegisterPayloadMin
  | AyPaymentsTenantRegisterPayloadFull;
...
export type AyPaymentsCustomerRegisterPayload =
  | AyPaymentsCustomerRegisterPayloadMin
  | AyPaymentsCustomerRegisterPayloadFull;
