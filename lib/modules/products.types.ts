...
export type AyPaymentsCreateProductPayload =
  | AyPaymentsCreateProductPayloadMin
  | AyPaymentsCreateProductPayloadFull;

export type AyPaymentsUpdateProductPayload =
  Partial<AyPaymentsCreateProductPayloadMin> &
  Partial<AyPaymentsCreateProductPayloadFull>;
